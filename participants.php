...
<!---->
        <div id="Carles" class="tabcontent">
          ...
          <div id="DavidT" class="tabcontent">
            <h3>David</h3>
          ...
          <button class="tablink" onclick="openCity('DavidT', this, '#00cc66')"> DavidS</button>
...
<div id="centrar">
          ...
          <img src="view/img/yo.gif" width="12%" height="50px;"alt="imatge tables">
          </center>
</div>
